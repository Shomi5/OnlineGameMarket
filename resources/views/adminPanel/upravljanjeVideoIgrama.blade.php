    ...
    <div class="tabelaManipulacijaKorisnika">
        <div class="dodajKorisnika" id="dodatiKorisnik">
            ...
            <form action="/adminPanel/dodajVideoIgru" id="dodajIgru" method="post" enctype="multipart/form-data">
                @csrf
                <div 
                    style="display: {{ session('igra_vec_postoji') ? 'block' : 'none' }};">
                    <p class="neuspeh" style="font-size: 18px;">Igra: <strong>{{ session('igra_vec_postoji') }} već postoji</strong></p>
                </div>
                        ...
                        <div class="promenaSlike bazaDugmeta">
                            <div class="pozicijaPromenaSlike bazaDugmeta">
                                <div class="izborSlike bazaDugmeta">
                                    ...
                                    <label for="kljuceviFajl" class="custom-file-label bazaDugmeta" id="slika">Unesite fajl
                                        sa ključevima</label>
        ...
        <div id="porukePopUp" class="popup {{ session('poruka') != null ? 'show' : '' }}">
            <div class="popup-content" style="background-color: rgb(89 133 199 / 49%);">
                @if (session('poruka') != null)
                    <div>
                        <h3 class="{{ session('informacije')[2]['vrednost'] == 0 ? 'errorKljuceva' : 'successKljuceva' }}">
                            {{ session('poruka') }}
                        </h3>
                    </div>
