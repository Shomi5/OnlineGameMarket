            ...
            <div>
                <div class="formaEdita">
                    ...
                    <div class="podaciEdita">
                        ...
                        <div class="potvradaDodavanjaKorisnika" id="potvrdaObrisanKorisnik" style="display: {{ session('uspesno_modifikovan_korinsik') ? 'block' : 'none' }};">
                            <h2 class="por">Uspešno ste dodali korisnika</h2>
                            <p clas="spot">Svi podaci su ispravno uneseni <strong>{{ session('uspesno_modifikovan_korinsik') }}</strong></p>
                        </div>  
            ...
            <div class="promenaSlike">
                ...
                <div class="pozicijaPromenaSlike">
                    <div class="pozicijaSlike">
                        <img src={{ Storage::disk('images')->exists('profilPhotos/' . $editUser->id . '.jpg')? asset('images/profilPhotos/' . $editUser->id . '.jpg'): asset('images/profilPhotos/blankoProfil.jpg') }} alt="...">
                    </div>
