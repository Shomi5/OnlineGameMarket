...
function prikaziDimenzije() {
    ...
    document.getElementById("dimenzijeEkrana").innerHTML = 
      `Širina ekrana: ${sirina}px, Visina ekrana: ${visina}px`;
}
...
window.addEventListener('load', function() {
  const potvrdaBrisanKorisnik = document.getElementById("potvrdaObrisanKorisnik");
