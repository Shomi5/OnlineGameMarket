...
<body>
    ...
    <main>
        <header  id="pocetakNava">
            <nav class="navbar mojibar skrolaj navbar-expand-lg fixed-top" id="navBarId">
                <div class="container-fluid">
                        <a class="navbar-brand me-auto" href="/"><img src="{{ asset('images/logo/Logo.png') }}" alt=""></a>
                    <div class="offcanvas pozadinaOffcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        aria-labelledby="offcanvasNavbarLabel">
                        <div class="offcanvas-header">
                            <h5 class="offcanvas-title"  id="offcanvasNavbarLabel"><img src="{{ asset('images/logo/Logo.png') }}" alt=""></h5>
                    ...
                    @guest
                            <x-dugmad-log  href="/login" >Ulogujte se</x-dugmad-log>
                    @endguest
    ...
    <script src="{{ asset('js/fadeShow.js') }}"></script>
